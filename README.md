...
- 🎓 B.Tech in **Artificial Intelligence & Data Science** @ Amrita Vishwa Vidyapeetham (2024–2028)
- 🤖 I build real-world AI systems — multi-agent pipelines, computer vision apps, and collaborative tools
- 🔭 Currently exploring: **LLM agents**, **prompt engineering**, and **full-stack AI apps**
- 📍 Based in India
...
|--------|-------------|-------|
| [🤖 Multi-Agent Doc Generator](https://github.com/Rish244-afk/multi-agent-ai-document-generator) | Writer → Reviewer → Improver pipeline; 60% less editing time | Python, Gemini API, Streamlit |
| [🍔 AI Food Analyzer](https://github.com/Rish244-afk/ai-food-analyzer) | 85–98% food classification accuracy + calorie estimation | MobileNetV2, Gemini API, Gradio |
| [💻 AI Code Editor](https://github.com/Rish244-afk/ai-collaborative-code-editor) | Real-time multi-user editing with <100ms sync | React, Node.js, Socket.io, Gemini |
